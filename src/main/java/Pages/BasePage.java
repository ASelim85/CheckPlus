...
//            String methodName = currentMethod.getName();
            ...
            File src = screenshot.getScreenshotAs(OutputType.FILE);
            FileUtils.copyFile(src, new File(
                    ".\\TestData\\ScreenShots\\SoftAssertions\\" + getClass().getName() + "\\" + currentMethod + "_" + BasePage.getCurrentDate() + ".png"));
        }
    }
    ...
    public void softAssertionEqual1(By locator, String expected) throws IOException {
        ...
        if (getContent(locator).equals(expected)) {
            ...
            File src = screenshot.getScreenshotAs(OutputType.FILE);
            FileUtils.copyFile(src, new File(
                    ".\\TestData\\ScreenShots\\SoftAssertions\\" + getClass().getName() + "\\" + methodName + "_" + BasePage.getCurrentDate() + ".png"));
        }
    }
