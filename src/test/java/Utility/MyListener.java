...
// TODO Auto-generated method stub
        ...
        for (String key : tests.keySet()) {
            System.out.println(STR."Key: \{key}, Value: \{tests.get(key)}");
        }
        ...
        for (ITestNGMethod perfMethod : perfMethods) {
            ...
            for (ITestResult testResult : testResultSet) {
                System.out.println(STR."Test \{testResult.getName()} failed, error \{testResult.getThrowable()}");
            }
        }
        ...
        for (ITestNGMethod perfMethod : perfMethods) {
            ...
            for (ITestResult testResult : testResultSet) {
                System.out.println(STR."Test \{testResult.getName()} passed, time took \{testResult.getEndMillis() - testResult.getStartMillis()}");
            }
        }
    }
}